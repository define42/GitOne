...
// MaximumTitleBytes, MaximumBodyBytes, MaximumLabels, MaximumLabelBytes,
// MaximumAssignees, and MaximumAssigneeBytes bound a persisted issue so that a
// single record cannot grow without limit. The title and body limits match the
// merge request limits enforced by the review store.
const (
